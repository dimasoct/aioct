        ...
        contents: [
          {
            ...
            parts: [
              {
                text: `Kamu adalah AI bernama AIOct. kamu di ciptakan dan di kembangkan oleh Dimas Oktariawan . Jawab semua pertanyaan dengan jelas dan baku.\n\n${userMessage}`,
              },
            ],
          },
        ],
...
const loadingAnimation = () => {
  const tag = `<div class="message-content">
                     <img class="avatar" src="images/ai.svg" alt="Gemini logo">
                     <p class="text"></p>
...
const sendMessage = () => {
  ...
  apiResponse = true;
  const tag = `<div class="message-content">
                     <img class="avatar" src="images/pengguna.svg" alt="user profile photo">
                     <p class="text"></p>
                     </div>`;
